...
Kel Knight and Kath Day have submitted their Notice of Intended Marriage on 23/09/2020. 

Following the marriage, please complete and submit this form as soon as possible.
...
<div class="nsw-forms">
        <div class="nsw-form-group">
            ...
            <legend>
            <span class="nsw-form-legend-text">Time (am/pm)</span>
            </legend>
            <div class="nsw-form-text">
               <input class="nsw-form-text__input" type="text" name="{ceremonytime}" id="{ceremonytime}" value="3:00pm">
            </div>
           </fieldset>
        </div>
    </div>
<div class="nsw-forms">
        <div class="nsw-form-group">
            <fieldset class="nsw-form-fieldset">
            <legend>
            <span class="nsw-form-legend-text">Day of week</span>
            </legend>
            <div class="nsw-form-text">
               <input class="nsw-form-text__input" type="text" name="{ceremonyday}" id="{ceremonyday}" value="Saturday">
            </div>
           </fieldset>
        </div>
    </div>
<div class="nsw-forms">
        <div class="nsw-form-group">
            ...
            <div class="nsw-form-text">
               <input class="nsw-form-text__input" type="text" name="{ceremonydate}" id="{ceremonydate}" value="07/11/2020">
            </div>
           </fieldset>
        </div>
    </div>
